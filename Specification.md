...
-Баттонам маргин авто?

### Вопросы ###
-nojs норм если абсолютом шапку закрывает? Или не заморачиваться
-У зеленых кнопок перенос строки br?
-Флекс мейн итема только column + фикс высота() или норм абсолют картинка?
-Ghostbtn вложенность, &--mail

-Волнистая граница
-Полоски в мобайл форме ширина до margin
