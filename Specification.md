...
-кнопку плей траснформ скейл?
-Отступ вверху ссылок сделать у сеарч и корзины нормальный?
-Сепаратор инлайном не повторяется - полвторятеся... хз пока оставить?

-в ie11 картинки не показываются? polyfill picture
-В ie11 кнопка Сделать заказ улетела

-Паддинг сделать у лого


### Вопросы ###
-Не пашет скрипт на 2-й 3-й корзине. И да, паддинги может увеличить? - квери селектор другой
